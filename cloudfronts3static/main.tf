...
resource "aws_s3_object" "content" {
  ...
  bucket                 =  aws_s3_bucket.cloudbucket.bucket
  key                    = "index.html"                              #########if you give /demo then  you give on browser --> cloudfronturl/demo        ....basically whatever you have write here you need to paste after cloudfront url compulsory  you can put name  anything here... it will save the name whatever you giving name as object in bucket 
